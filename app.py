...
if __name__=="__main__":
    ...
    dir_html_nuevo_root:Path = Path(__file__).parent/"Respuesta IA" # Ruta para el archivo html que contiene la pagina creada
    # Creamos el html a partir del contenido del archivo de texto
    main_html_maker(texto_root, html_base_root, dir_html_nuevo_root)
